...
def evaluate_convnext(model_path: str, val_dir: str):
    """
...
# MODEL_PATH = '/public/home/shenninggroup/zhhe/bia_coursework/convnext_tiny_glaucoma.pth'
# VAL_DIR = '/public/home/shenninggroup/zhhe/bia_coursework/Fundus_Scanes_Sorted/Validation'
# metrics = evaluate_convnext(MODEL_PATH, VAL_DIR)

def convnext_integrate(MODEL_PATH, VAL_DIR, CSV_PATH):
    """
...
if __name__ == '__main__':
    ...
    # Run evaluation
    eval_results = convnext_integrate(MODEL_PATH, VAL_DIR, CSV_PATH)